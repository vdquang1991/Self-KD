...
def build_resnet_18(input_shape, num_outputs, reg_factor=1e-4, activation='softmax', drop_rate=None):
    """Build resnet 18."""
...
def build_resnet_50(input_shape, num_outputs, reg_factor=1e-4, activation='softmax', drop_rate=None):
    """Build resnet 50."""
